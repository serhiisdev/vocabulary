...
enum OnboardingStepUi {
  ...
  howOldAreYou(),
  genderSelection(),
  customizeTheAppIntro(isIntro: true),
  howManyWords(),
  vocabularyLevel(),
  ...
  static OnboardingStepUi fromOnboardingStep(OnboardingStep step) {
    return switch (step) {
      ...
      OnboardingStep.customizeTheAppIntro => OnboardingStepUi.customizeTheAppIntro,
  ...
  OnboardingStep toOnboardingStep() {
    return switch (this) {
      ...
      OnboardingStepUi.customizeTheAppIntro => OnboardingStep.customizeTheAppIntro,
